...
async function getHottestNews(): Promise<string> {
  try {
    const prompt = `What are the hottest news stories of 2025 year? If you can't find any hottest news, provide some interesting global news stories instead. Provide a detailed summary of the top 3-5 global news items, including key details and sources if possible.`;
